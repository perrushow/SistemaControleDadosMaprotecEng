 ...
 */
final class Version20191012165333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE horarios_medico (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, dia VARCHAR(10) NOT NULL, hora VARCHAR(11) NOT NULL)');
